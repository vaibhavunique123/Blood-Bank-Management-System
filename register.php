...
if(mysqli_connect_error())
{
 ...
 $SELECT="SELECT email From register1_tbl Where email = ? Limit =1";
 $INSERT= "INSERT INTO `register1_tbl`('id' `name`, `phone`, `email`, `password`, `address`, `sex`, `age`, `blood group`, `city`) VALUES(?,?,?,?,?,?,?,?,?)";
 $stmt=$conn->prepare($_SELECT);
...
{
	echo"someone already  register email";
}
$stmt->close();
$conn->close();
}
...
<legend style="text-align:center;display: block;
    ...
    color: black;"><h1>User Register</h1></legend>
...
<input type="radio" value="m" name="sex"style="margin-left: 20px;">Female
<input type="radio" value="f" name="sex"style="margin-left: 20px;">Transgender<br>
</div><br>
<div class="bg" style="display:inline-flex;">
<div class="age"style="margin-top: 0px;margin-left: 65px;height:30px;margin-right:20px;">
<input type="number"  name="age" placeholder="Age"style="font-size:20px;width:70px;height: 30px"; required> 
</div> 
<div class="camp"style="margin-top: 0px;margin-right:40px;width: 100px;ba">
...
<div class="camp"style="margin-top: 35px;margin-left: 65px;width: 100px;">
...
<div class="submit"style="margin-top: 7px;margin-right: 10px;padding-bottom: 10px;">
		<input type="submit" value="Submit" style="width: 90px;background-color: yellow;font-size: 20px;">
</div>
<div class="submit"style="margin-top: 7px;padding-bottom: 10px;">
		<a href="#"><input type="submit" value="Reset" style="background-color:yellow;width: 90px;font-size: 20px;"></a>
</div> 
</div> 
</div></form>
