...
$id=$_GET['id'];
$insertquery="UPDATE bloodreq Set status ='Reject' WHERE  id=$id";
...
if($total==1)
{
     ...
     $body = "Sorry, $name \n We don't have  bloodgroup ( $bloodgroup ) that you have requested. \n If we will have that bloodgroup ( $bloodgroup ) then we will contact you as soon as possible through your registered email $email until before $date. ";
