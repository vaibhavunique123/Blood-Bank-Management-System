...
<head>
	...
	<body bgcolor="silver" style="background-image: url('gif/b1.gif'); background-repeat: no-repeat;background-attachment: fixed;
...
<legend style="text-align:center;display: block;
    ...
    margin-top: 15px;
    padding-right: 10px;
    background-color: grey;margin-right: 580px;background-image: url('gif/b1.gif'); background-repeat: no-repeat;background-attachment: fixed;
  background-size: cover;
    color: black;"><h1>Blood Request</h1></legend>
<form action="bloodreq.php" method="POST">
<div class="donar" style="margin-left:580px;background-color: grey;margin-right: 580px;background-image: url('gif/b1.gif'); background-repeat: no-repeat;background-attachment: fixed;
  background-size: cover;">
...
<div class="sex" style="margin-top: 10px;margin-left: 65px;height:30px; width=100px;color: white;">
...
<div class="camp"style="margin-top: 10px;margin-left: 65px;width: 100px;">
<select name="bloodgroup"style="width:200px;height: 30px;">
...
<div class="submit"style="margin-top: 10px;padding-bottom: 10px;">
		<a href="#"><input type="reset" value="Reset" name="r" style="background-color:yellow;width: 90px;font-size: 20px;"></a>
</div>
</div>
</div>
</form> 
<div class="foot" style="background-image: url('image/bbms.jpg');width: 1536px;display: inline-flex;margin-top: 80px;height:42px;background-color: green;">
...
$date=$_POST['date'];
$insertquery="INSERT INTO `bloodreq` (`name`, `email`, `address`, `sex`, `city`, `bloodgroup`, `date`) VALUES ('$name', '$email', '$address', '$sex','$city', '$bloodgroup', '$date')";
$result=mysqli_query($conn,$insertquery);
if($result)
{
	?> 
	      echo '<script>alert("Registered successfully  we  contact soon  to you through email ")</script>';
