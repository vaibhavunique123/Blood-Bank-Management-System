...
<body bgcolor="silver">
 <div class="menubar"style="background-image: url('image/bbms.jpg');">
	     <ul>
		 <img src="image/bbms5.webp" style="width: 166px;height: 85px;margin-right:10px ;padding-right: 20px;">
	     <li class="active" style="margin-right:900px;"><a href="adminhome.php">Home</a></li>		
         </ul>
</div>

<div class="about" style="background-color: green;width: 1535px;height:625px;font-size:35px;">
