...
?>    
                <tr style="border-width: 20px;color:green;">
                    ...
                    <td style="background-color: red;width:70px;"><a href="admindonarapp.php?id=<?php echo$res['id'];?>"<button type="button"name="b1" title="Approved"style="background-color: white;width: 70px;"><img src="image/r.jpg" style="width:70px;height:28px;"></button></a></td>
                    <td style="background-color: red;width:70px;"><a href="admindonarrej.php?id=<?php echo$res['id'];?>"<button type="button"name="b2" title="Reject"style="background-color: white;width: 70px;"><img src="image/w.jpg" style="width:70px;height:28px;"></button></a></td>
                    <td style="background-color: red;width:77px;"><a href="admindonardelete.php?id=<?php echo$res['id'];?>"<button type="button"name="b" title="DELETE"style="background-color: white;width: 70px;"><img src="image/delete.jpg" style="width:75px;height:28px;"></button></a></td>
      			</tr>
<?php
}
?>
